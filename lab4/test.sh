...
curl -X POST "http://localhost:8080/api/v1/transfers/908b8df3-47c6-4ebb-8e6f-c77a0f0bb7c8/confirm" \
     -u "9991112222:userpass" \
     -H "Content-Type: application/json" \
     -d '{"confirmationCode": "490490"}'


# admin
curl -X GET "http://localhost:8080/api/v1/transfers/908b8df3-47c6-4ebb-8e6f-c77a0f0bb7c8" \
     -u "admin:adminpass" \
     -H "Content-Type: application/json"
