...
public class JmsConfiguration {
  ...
  public MessageConverter jacksonJmsMessageConverter(
    ...
    // DTO, которые transfer-service ОТПРАВЛЯЕТ
    typeIdMappings.put(
    ...
    // DTO, которые transfer-service ПОЛУЧАЕТ (слушает)
    typeIdMappings.put(
  ...
  // с которыми взаимодействует transfer-service
  @Bean
  ...
  // Очереди, которые transfer-service СЛУШАЕТ
  @Bean
